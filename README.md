...
We can look at entries from this broken MFT with:

```fish
uv run tool.py mft record --raw exhibits/image/recovered.bin --entry 57
```

```text
Scanning recovered.bin for MFT entry #57…
────────────────────────── MFT Entry #57 — recovered.bin (raw scan) ───────────────────────────
╭───────────────────────────────────────── Hex Dump ──────────────────────────────────────────╮
│ 00000000  46 49 4C 45 30 00 03 00  22 03 22 00 00 00 00 00  |FILE0...".".....|              │
│ 00000010  01 00 01 00 38 00 03 00  E0 01 00 00 00 04 00 00  |....8...........|              │
│ 00000020  00 00 00 00 00 00 00 00  06 00 00 00 39 00 00 00  |............9...|              │
│ 00000030  05 00 00 00 00 00 00 00  10 00 00 00 60 00 00 00  |............`...|              │
│ 00000040  00 00 00 00 00 00 00 00  48 00 00 00 18 00 00 00  |........H.......|              │
│ 00000050  65 04 1A 31 B1 B9 DB 01  76 02 55 DA CD B9 DB 01  |e..1....v.U.....|              │
│ 00000060  76 02 55 DA CD B9 DB 01  33 27 5F 41 DE B9 DB 01  |v.U.....3'_A....|              │
│ 00000070  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|              │
│ 00000080  00 00 00 00 06 01 00 00  00 00 00 00 00 00 00 00  |................|              │
│ 00000090  00 00 00 00 00 00 00 00  30 00 00 00 70 00 00 00  |........0...p...|              │
│ 000000A0  00 00 00 00 00 00 02 00  54 00 00 00 18 00 01 00  |........T.......|              │
│ 000000B0  05 00 00 00 00 00 05 00  10 3C 7B A3 D6 B9 DB 01  |.........<{.....|              │
│ 000000C0  10 3C 7B A3 D6 B9 DB 01  10 3C 7B A3 D6 B9 DB 01  |.<{......<{.....|              │
│ 000000D0  10 3C 7B A3 D6 B9 DB 01  00 00 00 00 00 00 00 00  |.<{.............|              │
│ 000000E0  00 00 00 00 00 00 00 00  00 00 00 10 00 00 00 00  |................|              │
│ 000000F0  09 00 44 00 6F 00 63 00  75 00 6D 00 65 00 6E 00  |..D.o.c.u.m.e.n.|              │
│ 00000100  74 00 73 00 00 00 00 00  90 00 00 00 58 00 00 00  |t.s.........X...|              │
│ 00000110  00 04 18 00 00 00 05 00  38 00 00 00 20 00 00 00  |........8... ...|              │
│ 00000120  24 00 49 00 33 00 30 00  30 00 00 00 01 00 00 00  |$.I.3.0.0.......|              │
│ 00000130  00 10 00 00 01 00 00 00  10 00 00 00 28 00 00 00  |............(...|              │
│ 00000140  28 00 00 00 01 00 00 00  00 00 00 00 00 00 00 00  |(...............|              │
│ 00000150  18 00 00 00 03 00 00 00  00 00 00 00 00 00 00 00  |................|              │
│ 00000160  A0 00 00 00 50 00 00 00  01 04 40 00 00 00 03 00  |....P.....@.....|              │
│ 00000170  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|              │
│ 00000180  48 00 00 00 00 00 00 00  00 10 00 00 00 00 00 00  |H...............|              │
│ 00000190  00 10 00 00 00 00 00 00  00 10 00 00 00 00 00 00  |................|              │
│ 000001A0  24 00 49 00 33 00 30 00  21 01 A1 13 00 00 00 00  |$.I.3.0.!.......|              │
│ 000001B0  B0 00 00 00 28 00 00 00  00 04 18 00 00 00 04 00  |....(...........|              │
│ 000001C0  08 00 00 00 20 00 00 00  24 00 49 00 33 00 30 00  |.... ...$.I.3.0.|              │
│ 000001D0  01 00 00 00 00 00 00 00  FF FF FF FF 82 79 47 11  |.............yG.|              │
│ 000001E0  00 B0 59 0D 52 B9 DB 01  00 80 22 00 00 00 00 00  |..Y.R.....".....|              │
│ 000001F0  00 7A 22 00 00 00 00 00  20 00 00 00 00 00 00 00  |.z"..... .......|              │
│                                                                                             │
╰─────────────────────────────────────────────────────────────────────────────────────────────╯
╭────────────────────────────────────────── Fields ───────────────────────────────────────────╮
│                                                                                             │
...
│   0x0004     2   Update seq offset   30 00                     48                           │
│   0x0006     2   Update seq size     03 00                     3                            │
│   0x0008     8   Log file seq#       22 03 22 00 00 00 00 00   2229026                      │
│   0x0010     2   Sequence number     01 00                     1                            │
│   0x0012     2   Hard link count     01 00                     1                            │
│   0x0014     2   First attr offset   38 00                     0x0038                       │
│   0x0016     2   Flags               03 00                     0x0003  (In use,             │
│                                                                Directory)                   │
│   0x0018     4   Used size           E0 01 00 00               480 bytes                    │
│   0x001C     4   Allocated size      00 04 00 00               1024 bytes                   │
│   0x0020     8   Base record ref     00 00 00 00 00 00 00 00   0                            │
│   0x0028     2   Next attr ID        06 00                     6                            │
│   0x002C     4   Record number       39 00 00 00               57                           │
│                                                                                             │
╰─────────────────────────────────────────────────────────────────────────────────────────────╯
                               Attributes
╭────┬─────────────────────────────┬────────┬────────┬──────────┬──────╮
...
├────┼─────────────────────────────┼────────┼────────┼──────────┼──────┤
│  0 │ 0x10  $STANDARD_INFORMATION │ 0x0038 │     96 │ Yes      │ —    │
│  2 │ 0x30  $FILE_NAME            │ 0x0098 │    112 │ Yes      │ —    │
│  5 │ 0x90  $INDEX_ROOT           │ 0x0108 │     88 │ Yes      │ $I30 │
│  3 │ 0xA0  $INDEX_ALLOCATION     │ 0x0160 │     80 │ No       │ $I30 │
│  4 │ 0xB0  $BITMAP               │ 0x01B0 │     40 │ Yes      │ $I30 │
╰────┴─────────────────────────────┴────────┴────────┴──────────┴──────╯
      $STANDARD_INFORMATION details

  Field          Value
 ────────────────────────────────────────
  Created        2025-04-30 09:21:02 UTC
  Modified       2025-04-30 12:46:12 UTC
  MFT Modified   2025-04-30 12:46:12 UTC
  Accessed       2025-04-30 14:43:36 UTC
  File attrs     0x00000000
 ...
 ───────────────────────────────────────
  ...
  Namespace     POSIX
  Parent MFT#   5
  Created       2025-04-30 13:49:05 UTC
  Modified      2025-04-30 13:49:05 UTC
  Accessed      2025-04-30 13:49:05 UTC
  Alloc size    0 bytes
  Real size     0 bytes
```

If the target is a file, we can try to extract the file itself with:

```fish
uv run tool.py mft record --raw exhibits/image/recovered.bin --entry 60 -x tmp.bmp
```
...
Directory                       : .
File Size                       : 972 kB
File Modification Date/Time     : 2026:05:15 16:04:26+02:00
File Access Date/Time           : 2026:05:15 16:04:31+02:00
File Inode Change Date/Time     : 2026:05:15 16:04:26+02:00
